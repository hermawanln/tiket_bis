            ...
            <div class="inputForm">
                ...
                <div class="mr_movmain">
                    <div class="movits-left">
                            ...
                            <?php
                            // include("db.php");
                            $result =  mysqli_query($db,"SELECT * FROM rutetravel");
                            while($row = mysqli_fetch_array($result)){
                                echo '<option value= "'.$row['trvl_id'].'">';
                                echo $row['trvl_jalur'];
                                echo '</option>';
                            }
                            ?>
    ...
    <script>
        ...
        function takeData(){
            if(($("#Username").val().length == 0) || ($("#Numseats").val().length == 0)){
                alert("Silahkan Maskan data penumpang dan data kursi");
            }
            else{
                $(".inputForm").prop("disabled",true);
                $(".seatStructure *").prop("disabled",false);
                document.getElementById("notification").innerHTML = "<b style = 'margin-botom:0px;background:#ff9800;letter-spacing:1px;'> Pilih kursi dapat dilakukan </b>";
            }
            console.log("blyat");
        }
